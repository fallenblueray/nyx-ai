...
CREATE TABLE IF NOT EXISTS admin_prompts (
  ...
  key TEXT UNIQUE NOT NULL,           -- 提示詞標識，如 'character', 'outline', 'story'
...
-- 插入預設提示詞配置
INSERT INTO admin_prompts (key, name, description, content) VALUES
('character', '角色生成提示詞', '控制 AI 如何生成角色配對', 
...
('outline', '大綱生成提示詞', '控制 AI 如何生成三段式劇情大綱',
...
-- 創建管理員更新策略（需要服務端密鑰）
CREATE POLICY "Allow admin update" ON admin_prompts
